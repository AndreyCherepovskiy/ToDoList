...
<head>
    ...
    <script type="text/javascript" src="pages\script\mapping.js"></script>
...
<div class="tabbed_area">
    ...
    <ul class="tabs">
        <li><a id="tabTasksByAssignee" class="active">My tasks</a></li>
        <li><a id="tabTasksByAuthor">Other tasks</a></li>
    </ul>

    <div id="contentTasksByAssignee" class="content">
    ...
    <div id="contentTasksByAuthor" class="content">
        <h2 class="message">List task is empty.</h2>
